...
tf.app.flags.DEFINE_string('version', 'test_110_unbalance_data', '''A version number defining the directory to save
...
tf.app.flags.DEFINE_integer('test_batch_size', 128 , '''Test batch size''')#125
